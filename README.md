...
## 4 运行脚本
当前默认BASE网络，运行前先确定BASE或OP网络，取得data后并复制到程序中进行解析。所有投票地址将对这个交易对池投票。
...
<img width="2270" height="1608" alt="QQ_1778556212651" src="https://github.com/user-attachments/assets/a67c6a1d-cc9a-44e8-b64f-c7368e4f3410" />
